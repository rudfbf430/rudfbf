...
const blockedPattern =
  /송어|양식|낚시|횟집|수산|축산|동물|곤충|카페|펜션|민박|리조트|캠핑|학교|유치원|어린이집|병원|교회|성당|사찰|박물관|휴양림|백화점|아파트|빌라|부동산|공인중개|요양|재활|정육|식당|맛집|입구|주차장|골프|컨트리|호텔|모텔|게스트하우스|스테이|파크|랜드|유원지|놀이|테마파크|동물원|공방|직매장|마켓|유통센터|로컬푸드/;

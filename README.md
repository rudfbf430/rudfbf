...
- 전국 주요 권역의 제철 원예작물 24종과 시군 기반 소규모 농장·작목반 후보 3,354곳 추천
...
기본 등록 작물 데이터에 더해 전국 시군 이름과 작물명을 조합한 농장 후보 데이터를 자동 생성해 3,354곳 규모로 확장했습니다. 실제 서비스에서는 이 구조에 공공데이터 또는 농가 등록 데이터를 연결하면 됩니다.

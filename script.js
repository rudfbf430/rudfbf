const cropImages = {
  ...
  squash:
    "https://images.unsplash.com/photo-1570586437263-ab629fccc818?auto=format&fit=crop&w=900&q=80",
  eggplant:
    "https://images.unsplash.com/photo-1604321272882-07c73743be32?auto=format&fit=crop&w=900&q=80",
  radish:
    "https://images.unsplash.com/photo-1591971512572-45d3973b28c8?auto=format&fit=crop&w=900&q=80",
  broccoli:
    "https://images.unsplash.com/photo-1459411621453-7b03977f4bfc?auto=format&fit=crop&w=900&q=80",
  cherry:
    "https://images.unsplash.com/photo-1528821128474-27f963b062bf?auto=format&fit=crop&w=900&q=80",
  kiwi:
    "https://images.unsplash.com/photo-1585059895524-72359e06133a?auto=format&fit=crop&w=900&q=80",
  fig:
    "https://images.unsplash.com/photo-1601379760883-1bb497c55891?auto=format&fit=crop&w=900&q=80",
  chestnut:
...
const crops = [
  ...
  },
  {
    ...
    seasonMonths: [5, 6, 7, 8],
    image: cropImages.melon,
    description: "초여름부터 향과 아삭한 식감이 살아나는 노지·시설 재배 과채류입니다.",
    pickTip: "골이 선명하고 노란색이 고르며 들었을 때 묵직한 참외를 고르세요.",
    storageTip: "신문지로 감싸 냉장 보관하고, 자른 뒤에는 밀폐 용기에 담아 빠르게 드세요.",
    uses: ["생과", "샐러드", "화채"],
  },
  {
    id: "squash",
    ...
    localSources: [],
    seasonMonths: [5, 6, 7, 8, 9],
    image: cropImages.squash,
    description: "여름 식탁에서 볶음과 찌개에 자주 쓰이는 부드러운 과채류입니다.",
    pickTip: "표면에 윤기가 있고 크기가 너무 크지 않으며 탄력이 있는 것을 고르세요.",
    storageTip: "물기를 닦아 키친타월로 감싼 뒤 냉장 보관하세요.",
    uses: ["볶음", "전", "찌개"],
  },
  {
    id: "eggplant",
    ...
    localSources: [],
    seasonMonths: [6, 7, 8, 9],
    image: cropImages.eggplant,
    description: "더운 계절에 과육이 부드럽고 조리 흡수력이 좋은 여름 채소입니다.",
    pickTip: "보라색이 진하고 꼭지가 싱싱하며 표면에 상처가 적은 가지를 고르세요.",
    storageTip: "건조해지지 않게 감싸 냉장 보관하되 오래 두지 않는 것이 좋습니다.",
    uses: ["무침", "구이", "볶음"],
  },
  {
    id: "radish",
    ...
    regions: ["제주", "강원", "전남"],
    localSources: [],
    seasonMonths: [1, 2, 10, 11, 12],
    image: cropImages.radish,
    description: "가을과 겨울에 단맛이 좋아지는 김치·국물용 대표 근채류입니다.",
    pickTip: "표면이 매끈하고 단단하며 잎 부분이 싱싱한 무를 고르세요.",
    storageTip: "잎은 잘라 따로 보관하고 뿌리는 신문지에 감싸 냉장하세요.",
    uses: ["김치", "국", "조림"],
  },
  {
    id: "perilla",
    ...
    image: cropImages.lettuce,
    description: "향이 진하고 쌈·장아찌 활용도가 높은 대표 향채류입니다.",
    pickTip: "잎맥이 선명하고 향이 좋으며 검은 반점이 적은 깻잎을 고르세요.",
    storageTip: "꼭지 부분에 약간의 수분을 유지해 세워 냉장하면 덜 시듭니다.",
    uses: ["쌈", "장아찌", "전"],
  },
  {
    id: "chives",
    ...
    image: cropImages.greenonion || cropImages.onion,
    description: "봄과 가을에 향이 좋고 무침과 전으로 활용하기 좋은 엽채류입니다.",
    pickTip: "잎이 짙은 초록색이고 끝이 마르지 않은 부추를 고르세요.",
    storageTip: "씻지 않은 상태로 키친타월에 감싸 냉장 보관하세요.",
    uses: ["무침", "전", "국밥 고명"],
  },
  {
    id: "broccoli",
    ...
    localSources: [],
    seasonMonths: [1, 2, 3, 11, 12],
    image: cropImages.broccoli,
    description: "서늘한 계절에 꽃봉오리가 단단해지는 대표 화채류입니다.",
    pickTip: "꽃봉오리가 촘촘하고 진한 초록색이며 줄기가 마르지 않은 것을 고르세요.",
    storageTip: "랩이나 밀폐 용기에 담아 냉장하고 데친 뒤 냉동 보관도 가능합니다.",
    uses: ["데침", "볶음", "샐러드"],
  },
  {
    id: "cabbagehead",
    ...
    image: cropImages.cabbage,
    description: "서늘한 계절에 속이 단단하고 단맛이 좋아지는 저장성 채소입니다.",
    pickTip: "겉잎이 싱싱하고 들었을 때 묵직하며 속이 단단한 것을 고르세요.",
    storageTip: "자른 면을 랩으로 감싸 냉장 보관하고 필요한 만큼만 떼어 쓰세요.",
    uses: ["쌈", "샐러드", "볶음"],
  },
  {
    id: "asparagus",
    ...
    seasonMonths: [4, 5, 6],
    image: cropImages.greenonion || cropImages.onion,
    description: "봄철 새순을 수확하는 고급 줄기채소로 구이와 볶음에 잘 어울립니다.",
    pickTip: "줄기가 곧고 단단하며 끝 봉오리가 벌어지지 않은 것을 고르세요.",
    storageTip: "밑동을 살짝 적신 키친타월로 감싸 세워 냉장 보관하세요.",
    uses: ["구이", "볶음", "파스타"],
  },
  {
    id: "cherry",
    ...
    localSources: [],
    seasonMonths: [6, 7],
    image: cropImages.cherry,
    description: "초여름에 짧게 출하되는 고당도 과일로 신선도가 특히 중요합니다.",
    pickTip: "꼭지가 초록빛이고 알이 단단하며 색이 진한 체리를 고르세요.",
    storageTip: "씻지 않고 냉장 보관하다가 먹기 직전에 씻으세요.",
    uses: ["생과", "디저트", "청"],
  },
  {
    id: "kiwi",
    ...
    image: cropImages.kiwi,
    description: "남부권에서 늦가을부터 출하되는 후숙형 과일입니다.",
    pickTip: "상처가 적고 손으로 살짝 눌렀을 때 너무 무르지 않은 것을 고르세요.",
    storageTip: "단단한 것은 실온에서 후숙하고 익은 뒤에는 냉장 보관하세요.",
    uses: ["생과", "스무디", "샐러드"],
  },
  {
    id: "jujube",
    ...
    seasonMonths: [9, 10],
    image: cropImages.apple,
    description: "가을에 생대추와 건대추로 모두 활용되는 저장성 과일입니다.",
    pickTip: "껍질이 윤기 있고 단단하며 주름이 과하지 않은 생대추를 고르세요.",
    storageTip: "생대추는 냉장 보관하고 오래 둘 것은 말리거나 냉동하세요.",
    uses: ["생과", "차", "약식"],
  },
  {
    id: "crownDaisy",
    ...
    image: cropImages.lettuce,
    description: "향이 좋아 전골과 샤브샤브에 자주 쓰이는 서늘한 계절 엽채류입니다.",
    pickTip: "잎이 짙고 줄기가 너무 굵지 않으며 향이 선명한 쑥갓을 고르세요.",
    storageTip: "키친타월로 감싸 밀폐 용기에 넣어 냉장 보관하세요.",
    uses: ["전골", "무침", "샐러드"],
  },
  {
    id: "bokchoy",
    ...
    image: cropImages.cabbage,
    description: "아삭한 줄기와 부드러운 잎이 특징인 볶음용 엽채류입니다.",
    pickTip: "잎 색이 선명하고 밑동이 단단하며 무르지 않은 것을 고르세요.",
    storageTip: "씻지 않은 상태로 냉장 보관하고 조리 직전에 세척하세요.",
    uses: ["볶음", "국", "찜"],
  },
  {
    id: "kale",
    ...
    image: cropImages.lettuce,
    description: "쌈과 주스용 수요가 높은 진녹색 잎채소입니다.",
    pickTip: "잎이 두껍고 색이 진하며 가장자리가 마르지 않은 케일을 고르세요.",
    storageTip: "물기를 피하고 키친타월과 함께 밀폐해 냉장 보관하세요.",
    uses: ["쌈", "주스", "샐러드"],
  },
  {
    id: "waterParsley",
    ...
    image: cropImages.greenonion || cropImages.onion,
    description: "봄철 향이 좋아 무침과 탕에 많이 쓰이는 향채류입니다.",
    pickTip: "줄기가 곧고 잎이 싱싱하며 향이 맑은 미나리를 고르세요.",
    storageTip: "밑동을 살짝 적셔 세워 냉장하면 신선도를 유지하기 좋습니다.",
    uses: ["무침", "탕", "전"],
  },
  {
    id: "lotusRoot",
    ...
    seasonMonths: [9, 10, 11, 12],
    image: cropImages.radish,
    description: "가을부터 겨울까지 아삭한 식감이 좋은 뿌리채소입니다.",
    pickTip: "구멍 안쪽이 깨끗하고 표면 상처가 적으며 묵직한 연근을 고르세요.",
    storageTip: "자른 면은 랩으로 밀착해 냉장하고 갈변을 막으려면 식초물에 담가두세요.",
    uses: ["조림", "튀김", "샐러드"],
  },
  {
    id: "burdock",
    ...
    image: cropImages.radish,
    description: "겨울철 조림과 김밥 재료로 활용하기 좋은 향 있는 근채류입니다.",
    pickTip: "너무 굵지 않고 단단하며 흙이 적당히 묻어 있는 우엉을 고르세요.",
    storageTip: "신문지로 감싸 서늘하게 두거나 손질 후 냉장 보관하세요.",
    uses: ["조림", "김밥", "차"],
  },
  {
    id: "chestnut",
    ...
    localSources: [],
    seasonMonths: [9, 10, 11],
    image: cropImages.chestnut,
    description: "가을 산지에서 수확되는 저장성 높은 견과성 과실입니다.",
    pickTip: "껍질에 윤기가 있고 무게감이 있으며 벌레 구멍이 없는 밤을 고르세요.",
    storageTip: "밀폐해 냉장 보관하거나 삶아서 냉동하면 오래 보관할 수 있습니다.",
    uses: ["삶은 밤", "밥", "디저트"],
  },
  {
    id: "plumApricot",
    ...
    seasonMonths: [5, 6],
    image: cropImages.plum,
    description: "초여름에 청과 장아찌 재료로 많이 찾는 짧은 제철 과실입니다.",
    pickTip: "표면이 단단하고 상처가 적으며 색이 고른 매실을 고르세요.",
    storageTip: "수확 후 빠르게 손질해 청이나 장아찌로 담그는 것이 좋습니다.",
    uses: ["청", "장아찌", "소스"],
  },
  {
    id: "schisandra",
    ...
    seasonMonths: [8, 9, 10],
    image: cropImages.cherry,
    description: "늦여름부터 가을까지 청과 차 재료로 수요가 높은 특용 과실입니다.",
    pickTip: "알이 탱탱하고 붉은빛이 선명하며 짓무름이 적은 것을 고르세요.",
    storageTip: "생과는 빠르게 세척해 청으로 담그거나 냉동 보관하세요.",
    uses: ["청", "차", "에이드"],
  },
  {
    id: "yuja",
    ...
    image: cropImages.mandarin,
    description: "겨울 향이 진하고 청과 차로 활용하기 좋은 감귤류 과실입니다.",
    pickTip: "껍질 향이 진하고 상처가 적으며 묵직한 유자를 고르세요.",
    storageTip: "실온에 오래 두지 말고 세척 후 청으로 담그거나 냉장 보관하세요.",
    uses: ["청", "차", "드레싱"],
  },
  {
    id: "fig",
    ...
    localSources: [],
    seasonMonths: [8, 9, 10],
    image: cropImages.fig,
    description: "늦여름부터 가을까지 부드러운 과육과 향이 좋은 과일입니다.",
    pickTip: "껍질이 갈라지기 직전의 향이 좋고 너무 무르지 않은 것을 고르세요.",
    storageTip: "쉽게 무르므로 냉장 보관 후 빠르게 드세요.",
    uses: ["생과", "잼", "샐러드"],
  },
  {
    id: "celery",
    ...
    image: cropImages.greenonion || cropImages.onion,
    description: "향과 아삭한 식감이 좋아 샐러드와 주스에 쓰이는 줄기채소입니다.",
    pickTip: "줄기가 단단하고 색이 선명하며 잎이 시들지 않은 셀러리를 고르세요.",
    storageTip: "잎과 줄기를 분리해 밀폐 용기에 담아 냉장 보관하세요.",
    uses: ["샐러드", "주스", "볶음"],
  },
];
...
const farmCityCenters = [
  ["경기", "수원시", 37.2636, 127.0286], ["경기", "고양시", 37.6584, 126.832], ["경기", "용인시", 37.2411, 127.1776], ["경기", "성남시", 37.42, 127.1265], ["경기", "화성시", 37.1995, 126.8312], ["경기", "남양주시", 37.636, 127.2165], ["경기", "평택시", 36.9921, 127.1127], ["경기", "파주시", 37.7599, 126.7799], ["경기", "김포시", 37.6153, 126.7156], ["경기", "광주시", 37.4294, 127.255], ["경기", "이천시", 37.272, 127.435], ["경기", "안성시", 37.008, 127.2798], ["경기", "포천시", 37.8949, 127.2003], ["경기", "양평군", 37.4918, 127.4876], ["경기", "여주시", 37.298, 127.637], ["경기", "가평군", 37.8315, 127.5099], ["경기", "연천군", 38.0964, 127.075],
  ["강원", "춘천시", 37.8813, 127.7298], ["강원", "원주시", 37.3422, 127.9202], ["강원", "강릉시", 37.7519, 128.8761], ["강원", "동해시", 37.5248, 129.1143], ["강원", "태백시", 37.164, 128.9857], ["강원", "속초시", 38.207, 128.5918], ["강원", "삼척시", 37.4499, 129.1652], ["강원", "홍천군", 37.6972, 127.8885], ["강원", "횡성군", 37.4918, 127.985], ["강원", "영월군", 37.1838, 128.4618], ["강원", "평창군", 37.3705, 128.3901], ["강원", "정선군", 37.3806, 128.6609], ["강원", "철원군", 38.1467, 127.3135], ["강원", "화천군", 38.1062, 127.7082], ["강원", "양구군", 38.1101, 127.9898], ["강원", "인제군", 38.0697, 128.1703], ["강원", "고성군", 38.3806, 128.4676], ["강원", "양양군", 38.0754, 128.619],
  ["충북", "청주시", 36.6424, 127.489], ["충북", "충주시", 36.991, 127.9259], ["충북", "제천시", 37.1326, 128.191], ["충북", "보은군", 36.4895, 127.7295], ["충북", "옥천군", 36.3065, 127.5713], ["충북", "영동군", 36.175, 127.7766], ["충북", "진천군", 36.8554, 127.4356], ["충북", "괴산군", 36.8154, 127.7866], ["충북", "음성군", 36.9402, 127.6905], ["충북", "단양군", 36.9845, 128.3656], ["충북", "증평군", 36.7852, 127.5816],
  ["충남", "천안시", 36.8151, 127.1139], ["충남", "공주시", 36.4466, 127.119], ["충남", "보령시", 36.3335, 126.6129], ["충남", "아산시", 36.7898, 127.0018], ["충남", "서산시", 36.7845, 126.4503], ["충남", "논산시", 36.1871, 127.0988], ["충남", "계룡시", 36.2745, 127.2486], ["충남", "당진시", 36.8898, 126.6459], ["충남", "금산군", 36.1089, 127.4881], ["충남", "부여군", 36.2757, 126.9098], ["충남", "서천군", 36.0803, 126.6918], ["충남", "청양군", 36.4591, 126.8022], ["충남", "홍성군", 36.6013, 126.6608], ["충남", "예산군", 36.6826, 126.848], ["충남", "태안군", 36.7456, 126.2979],
  ["전북", "전주시", 35.8242, 127.148], ["전북", "군산시", 35.9677, 126.7366], ["전북", "익산시", 35.9483, 126.9576], ["전북", "정읍시", 35.5699, 126.856], ["전북", "남원시", 35.4164, 127.3904], ["전북", "김제시", 35.8036, 126.8809], ["전북", "완주군", 35.9047, 127.1621], ["전북", "진안군", 35.7917, 127.4249], ["전북", "무주군", 36.0068, 127.6608], ["전북", "장수군", 35.6473, 127.5212], ["전북", "임실군", 35.6178, 127.2891], ["전북", "순창군", 35.3744, 127.1376], ["전북", "고창군", 35.4358, 126.7021], ["전북", "부안군", 35.7316, 126.7335],
  ["전남", "목포시", 34.8118, 126.3922], ["전남", "여수시", 34.7604, 127.6622], ["전남", "순천시", 34.9506, 127.4874], ["전남", "나주시", 35.0158, 126.7108], ["전남", "광양시", 34.9407, 127.6959], ["전남", "담양군", 35.3211, 126.9879], ["전남", "곡성군", 35.282, 127.2919], ["전남", "구례군", 35.2025, 127.4629], ["전남", "고흥군", 34.6112, 127.2847], ["전남", "보성군", 34.7715, 127.0801], ["전남", "화순군", 35.0645, 126.9865], ["전남", "장흥군", 34.6816, 126.9069], ["전남", "강진군", 34.6421, 126.7672], ["전남", "해남군", 34.5734, 126.5993], ["전남", "영암군", 34.8002, 126.6968], ["전남", "무안군", 34.9904, 126.4817], ["전남", "함평군", 35.0659, 126.5166], ["전남", "영광군", 35.2772, 126.512], ["전남", "장성군", 35.3019, 126.7848], ["전남", "완도군", 34.311, 126.7551], ["전남", "진도군", 34.4868, 126.2635], ["전남", "신안군", 34.8336, 126.3511],
  ["경북", "포항시", 36.019, 129.3435], ["경북", "경주시", 35.8562, 129.2247], ["경북", "김천시", 36.1398, 128.1136], ["경북", "안동시", 36.5684, 128.7294], ["경북", "구미시", 36.1195, 128.3446], ["경북", "영주시", 36.8057, 128.624], ["경북", "영천시", 35.9733, 128.9386], ["경북", "상주시", 36.4109, 128.1591], ["경북", "문경시", 36.5866, 128.1868], ["경북", "경산시", 35.8251, 128.7415], ["경북", "의성군", 36.3527, 128.6972], ["경북", "청송군", 36.4359, 129.0571], ["경북", "영양군", 36.6668, 129.1124], ["경북", "영덕군", 36.4151, 129.3657], ["경북", "청도군", 35.6474, 128.7341], ["경북", "고령군", 35.725, 128.2628], ["경북", "성주군", 35.919, 128.2829], ["경북", "칠곡군", 35.9956, 128.4016], ["경북", "예천군", 36.6577, 128.4529], ["경북", "봉화군", 36.8931, 128.7324], ["경북", "울진군", 36.9931, 129.4006], ["경북", "울릉군", 37.4844, 130.9057],
  ["경남", "창원시", 35.227, 128.6811], ["경남", "진주시", 35.1803, 128.1076], ["경남", "통영시", 34.8544, 128.4332], ["경남", "사천시", 35.0038, 128.0642], ["경남", "김해시", 35.2285, 128.8893], ["경남", "밀양시", 35.5038, 128.7466], ["경남", "거제시", 34.8806, 128.621], ["경남", "양산시", 35.335, 129.037], ["경남", "의령군", 35.3222, 128.2617], ["경남", "함안군", 35.2726, 128.4065], ["경남", "창녕군", 35.5446, 128.4923], ["경남", "고성군", 34.9731, 128.3222], ["경남", "남해군", 34.8377, 127.8925], ["경남", "하동군", 35.0673, 127.7513], ["경남", "산청군", 35.4156, 127.8735], ["경남", "함양군", 35.5205, 127.7252], ["경남", "거창군", 35.6865, 127.9095], ["경남", "합천군", 35.5667, 128.1658],
  ["제주", "제주시", 33.4996, 126.5312], ["제주", "서귀포시", 33.2541, 126.5601], ["부산", "부산광역시", 35.1796, 129.0756],
];
...
function getFarmDisplayLocation(source) {
  if (!source) return "";
  const city = getFarmCity(source);
  return [farmRegionNames[source.region] || source.region, city].filter(Boolean).join(" ");
}

function getFarmCity(source) {
  if (source.city && !source.city.endsWith("권")) {
    return normalizeFarmCity(source.city);
  }
  if (!source.lat || !source.lng) return "";
  const candidates = farmCityCenters.filter(([region]) => region === source.region);
  const nearest = candidates.reduce((best, current) => {
    const distance = distanceKm(
      { lat: source.lat, lng: source.lng },
      { lat: current[2], lng: current[3] }
    );
    return !best || distance < best.distance ? { name: current[1], distance } : best;
  }, null);
  return nearest ? `${nearest.name} 인근` : "";
}

function normalizeFarmCity(city) {
  if (city.includes(" ")) return city;
  if (city.endsWith("시") || city.endsWith("군") || city.endsWith("구")) return city;
  return `${city}시`;
}
